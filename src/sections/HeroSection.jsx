      ...
      <div className="hero-container relative bg-milk w-screen h-dvh overflow-hidden">
        <div className="hero-content opacity-0 relative z-10 w-full h-full flex flex-col justify-center items-center translate-y-10">
          <div className="overflow-hidden">
            <h1 className="hero-title text-dark-blue font-bold uppercase xl:text-[7rem] lg:text-[6rem] md:text-[5.5rem] text-[3.3rem] -mb-2 md:-mb-6">
              Real Taste With
            </h1>
          </div>

          <div
            className="hero-text-scroll -rotate-3 mb-8 lg:rounded-4xl rounded-2xl"
            style={{
              clipPath: "polygon(50% 0, 50% 0, 50% 100%, 50% 100%)",
            }}
          >
            <div className="hero-subtitle bg-dark-blue border-[.8vw] border-milk lg:rounded-4xl rounded-2xl">
              <h1 className="font-anton uppercase xl:text-[7rem] lg:text-[6rem] md:text-[5.5rem] text-[3.3rem] text-milk px-3">
                Real Power
              </h1>
            </div>
          </div>
          ...
          <a className="mt-8 p-1 md:p-2 border rounded-full border-dark-blue border-dashed"
          target='_blank'
          ...
          >
            <div
              ...
              className="text-milk bg-dark-blue uppercase font-bold text-lg rounded-full py-2 px-5 md:px-10 cursor-pointer select-none relative"
            >
              Shop All
            </div>
          </a>
